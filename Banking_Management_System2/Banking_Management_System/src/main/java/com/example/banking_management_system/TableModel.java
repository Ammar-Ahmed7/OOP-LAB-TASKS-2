...
public class TableModel {
    String AccNo_Col,AccType_Col,Country_Col,DOB_Col,Gender_Col,NIC_Col,Name_Col,Phone_Col;

    public TableModel(String AccNo_Col, String AccType_Col, String Country_Col, String DOB_Col, String Gender_Col, String NIC_Col, String Name_Col, String Phone_Col) {
